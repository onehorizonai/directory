...
Review: **reconstruct** this model from the plan, mock, or build.
Do not invent priorities. Visual taste is not a finding.
...
that as a coverage gap — do not invent actors or priorities.
