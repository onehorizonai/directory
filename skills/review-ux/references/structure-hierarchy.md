...
Visual size and hit area need not match. Follow the **surface's**
platform target guidance (HIG, Material, WCAG, or the product's own
minimum) — do not invent one universal pixel size.
