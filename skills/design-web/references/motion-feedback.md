...
On-demand method for [../SKILL.md](../SKILL.md). Load when specifying
interaction, motion, feedback, recovery, or accessibility as part of the
design — after priority and structure exist.
...
On the web, prefer semantic HTML and established patterns before
custom widgets. Do not copy iOS/Android chrome into the browser.
...
Not a final paint pass. While specifying each important use case:
...
Prefer semantic HTML and established ARIA patterns before custom
widgets. Do not invent a widget the platform already provides.
