...
Browser: after the model is stable, apply the product design system
and current web UI / WCAG guidance — not a native-app chrome transplant.
...
If the outcome is undefined, stop — do not invent screens.
