...
reconstruct it from the running interface and the product — then judge
the UI against that model, not against taste. Do not invent priorities;
...
12. Does it adapt correctly to relevant window / size-class changes?
