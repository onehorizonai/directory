...
On the web, prefer semantic HTML and established patterns. Flag
native-app chrome transplanted into the browser when it fights the web.
...
Prefer semantic HTML and established ARIA; verify in the real DOM /
accessibility tree, not by visual inspection alone.
